...
In this extremely simple case of small dimensions and without difficulty, the
control parameters remain the same. The results are of the same quality as for
the reference variational optimization.
