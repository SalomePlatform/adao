...
.. index:: single: Séquence de Halton
...
SampleAsMinMaxHaltonSequence
  ...
  *[Dimension, Nombre]* comportant la dimension de l'espace des états et le
  ...
  construit automatiquement selon la méthode de séquences de Halton. Par
  ...
  *Remarque : il est nécessaire de disposer de Scipy en version supérieure à
  ...
  Exemple :
  ``{"SampleAsMinMaxHaltonSequence":[[0.,1.],[-1,3]]+[[2,11]]}`` pour un espace d'état de dimension 2 et au moins 11 points d'échantillonnage (il y aura 16 points en pratique).
