...
# --------------------------------------------------------
# Generated by AdaoCatalogGenerator on 2026-03-31 19:19:01
# --------------------------------------------------------
...
def F_AlgorithmParameters(statut, algos_names, fv=NoCheckInNS) : return FACT(
    ...
    ParametersSamplingTest = BLOC (condition = " (Parameters == 'Defaults') and (Algorithm == 'SamplingTest') ",
        ...
        SampleAsMinMaxHaltonSequence = SIMP(statut="f", typ="TXM", max="**", into=None, fr="Points de calcul définis par une séquence de Halton dont on donne les bornes de chaque variable par une paire [min,max], suivi de la paire [dimension, nombre minimal de points demandés]"),
