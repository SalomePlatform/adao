...
def Calcul_Aster_Ponctuel( X0 = None ):
    ...
    sys.path.append(os.path.join(ASTER_ROOT, 'lib', 'python2.4', 'site-packages'))
    if debug:
        print sys.path
    try:
...
if __name__ == "__main__":
    ...
    HX = Calcul_Aster_Ponctuel( X0 = [ 80000.,  1000., 30. ] )
    print
    print "HX =",HX
    print
#     g = Calcul_Aster_Jacobienne( X0  = [ 80000.,  1000., 30. ] )
#     print "g =",g
    print
